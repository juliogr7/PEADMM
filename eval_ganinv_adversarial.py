...
def init_parser():
    ...
    parser.add_argument('--save-name', default='eval_autoencoder_digit_mnist_test100',
...
def main():
    ...
    wandb.Api()
    wandb.init(project='autoencoder_adversarial_mnist_cameraready', entity=entity_name, name=config, config=args)
    ...
    trainer.test(model, test_loader,
                 ckpt_path='results/pretrained_adversarial/'
