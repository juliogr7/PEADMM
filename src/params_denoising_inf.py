...
# PARAMS DENOISING WITH L_infinity norm
...
mnist_params_elu = {
    'gd': {'lr': .0001}, # 1.269515487e-03
    # 'gd': {'lr': 1.}, # 1.272521331e-03
    # 'gd': {'lr': .1}, # 1.273348578e-03
    ...
    'l1eadmm': {'gamma': .05, 'beta': 0.05, 'sigma': 0.05, 'x_update': 'exact'},
    'linfeadmm': {'gamma': 0.01, 'beta': 0.00000000005, 'sigma': 0.00000000005, 'x_update': 'exact'},
    # 'linfeadmm': {'gamma': 0.01, 'beta': 0.00000000005, 'sigma': 0.00000000005, 'x_update': 'exact'}, 1.659 e-4
...
celeba_params_elu = {
    ...
    'l1eadmm': {'gamma': .1, 'beta': 1, 'sigma': 1., 'x_update': 'exact'},
    'ladmm': {'gamma': 1.0, 'beta': 50, 'sigma': 400, 'x_update': 'linear'},
