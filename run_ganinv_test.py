...
def main():
    ...
    # model
    model = Autoencoder_GAN_MNIST(elu_gan=args.elu_gan, elu_encoder=args.elu_encoder)
    ...
    dir = os.path.join('results', 'autoencoder', 'autoencoder_digit_mnist_test100', 'checkpoints',
                        'epoch=55-step=55_normal.ckpt')
    ...
    fig, axes = plt.subplots(2, args.test_examples, figsize=(args.test_examples * 2, 5))
    ...
    fig.text(0.04, 0.26, 'Reconstructed', va='center', ha='left', fontsize=14, weight='bold', rotation=90)
